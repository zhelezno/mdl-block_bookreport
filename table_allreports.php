...
$PAGE->set_url($table_allreportsurl);
$PAGE->set_context(\context_system::instance());
$PAGE->set_title(get_string('allreports', 'block_bookreport'));
$PAGE->set_heading(get_string('allreports', 'block_bookreport'));

$PAGE->navbar->add(get_string('shortpluginname', 'block_bookreport'), $indexurl);
$PAGE->navbar->add(get_string('allreports', 'block_bookreport'));
